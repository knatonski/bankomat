...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(68, 67);
			...
			this->button2->Location = System::Drawing::Point(68, 145);
			...
			this->button3->Location = System::Drawing::Point(68, 222);
			...
			this->button4->Location = System::Drawing::Point(68, 299);
			...
			this->button5->Location = System::Drawing::Point(802, 67);
			...
			this->button6->Location = System::Drawing::Point(802, 145);
			...
			this->button7->Location = System::Drawing::Point(802, 222);
			...
			this->button8->Location = System::Drawing::Point(802, 299);
			...
			this->pictureBox1->Location = System::Drawing::Point(178, 32);
			...
			this->textBox1->Location = System::Drawing::Point(465, 180);
			...
			this->label1->Location = System::Drawing::Point(236, 181);
			this->label1->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(225, 20);
			this->label1->TabIndex = 10;
			this->label1->Text = L"Wprowadz Numer Klienta:";
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Modern No. 20", 13.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(284, 216);
			this->label2->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(176, 20);
			this->label2->TabIndex = 11;
			this->label2->Text = L"Wprowadz kod PIN:";
			...
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10.2F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->textBox2->Location = System::Drawing::Point(465, 216);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Modern No. 20", 13.8F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(711, 321);
			this->label3->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(80, 21);
			this->label3->TabIndex = 13;
			this->label3->Text = L"Akceptuj";
			// 
			// label4
			// 
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"Modern No. 20", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label4->Location = System::Drawing::Point(386, 110);
			...
			this->ClientSize = System::Drawing::Size(979, 490);
...
#pragma endregion
	private: System::Void button8_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (b.zaloguj(nr_konta, pin)) {
			label4->Text = "Zalogowano pomyœlnie";
		}
		else
		{
